...
<head>
    ...
    <title>ThinkTalk - Admin Paneli</title>
    ...
    <div class="container">
        ...
        while ($konu = $konu_result->fetch_assoc()) {
            ...
            echo "<div class='card-header'>
                <h5>" . htmlspecialchars($konu['baslik']) . "</h5>
                <small> (Açan: " . htmlspecialchars($konu['konuyu_acan']) . ")</small>
                <form method='POST' action='sil_konu.php' style='display:inline; float:right;'>
            ...
            while ($yorum = $yorum_result->fetch_assoc()) {
                echo "<li class='list-group-item'>
                    <form method='POST' action='sil_yorum.php' style='display:inline;'>
