    ...
    <form action="" method="post">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="kullanici_adi" class="form-control" id="inputUsername" placeholder="Kullanıcı Adı" required>
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" name="parola" class="form-control" id="inputPassword4" placeholder="Parola giriniz" required>
            </div>
        </div>
        <div>
